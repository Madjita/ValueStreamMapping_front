...
import { Theme, ComponentsPropsList } from '@mui/material/styles';
 ...
 */
interface DataGridProProps extends Omit<Partial<DataGridProPropsWithDefaultValue> & DataGridPropsWithComplexDefaultValueBeforeProcessing & DataGridProPropsWithoutDefaultValue, DataGridProForcedPropsKey> {
    /**
