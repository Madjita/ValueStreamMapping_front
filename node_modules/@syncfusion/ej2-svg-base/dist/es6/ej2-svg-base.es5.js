...
var Tooltip = /** @__PURE__ @class */ (function (_super) {
    ...
    Tooltip.prototype.getTextContent = function (text) {
        var texts = text.match(/<[a-zA-Z\/](.|\n)*?>/g);
        if (isNullOrUndefined(texts)) {
            return text;
        }
        var isRtlText = /[\u0590-\u07FF\u200F\u202B\u202E\uFB1D-\uFDFD\uFE70-\uFEFC]/.test(text);
    ...
    Tooltip.prototype.sharedTooltipLocation = function (bounds, x, y) {
        ...
        var tooltipDivEndValue = tooltipRect.y + tooltipRect.height;
        var boundsEndValue = bounds.y + bounds.height;
        var isStockChart = false;
        var heightDifference;
        if (this.controlInstance) {
            var containerDivID = this.controlInstance["element"]["id"];
