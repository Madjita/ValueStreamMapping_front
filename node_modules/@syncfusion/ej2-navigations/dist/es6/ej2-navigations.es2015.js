 ...
 * @hidden
 */
function addScrolling(createElem, container, content, scrollType, enableRtl, offset) {
    let containerOffset;
    let contentOffset;
    ...
    if (containerOffset < contentOffset) {
        ...
        let width = parentElem.getBoundingClientRect().width;
...
let Toolbar = class Toolbar extends Component {
    ...
    createPopup() {
        ...
        let ele;
        const popupPri = [];
        const popupEle = document.getElementById(element.id + '_popup');
